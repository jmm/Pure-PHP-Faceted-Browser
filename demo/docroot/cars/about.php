...
<p>
All of the data used in this demo is completely made up, except for the make and model names.  Because the data is randomly generated it may be nonsensical.  Some things that may not be particularly helpful are deliberately included in the UI to more fully demonstrate the software.  For example, it's not likely to be very helpful to choose a maximum MPG.  The Color facet is configured to show empty terms to demonstrate that option.
</p>
